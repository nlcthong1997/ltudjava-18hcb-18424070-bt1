...
//					window.frame.setVisible(true);
	 ...
	 */
	public vListPoint_Pass(String id, String userName, String type, String cLass) throws IOException {
	...
	private void initialize(String id, String userName, String type, String cLass) throws IOException {
		...
		ArrayList<mPoint> listPassPoint = cPoint.getListPassPoint(cLass);
