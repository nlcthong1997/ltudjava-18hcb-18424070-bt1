...
//					window.frame.setVisible(true);
	 ...
	 */
	public vStudent(String id, String idStudent, String type) throws IOException {
	...
	private void initialize(String id, String idStudent, String type) throws IOException {
		...
		btnDoiMatKhau.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				frame.dispose();
				vChangePassword window = new vChangePassword(id, idStudent, type);
				window.frame.setVisible(true);
			}
		});
	...
	private void renderDataTable (JTable table, String idStudent, String subjectName) throws IOException {
		...
		if (!subjectName.equals("")) {
			for (mPoint pointStudent : cStudent.getDiemAllSubjectWithStudent(idStudent)) {
	...
	private void loadComboboxSubjectOfStudent (JComboBox<String> comboBoxMon, String userName) {
		...
		try {
			...
			for (String cLass : cStudent.getListSubjectOfStudent(userName)) {
